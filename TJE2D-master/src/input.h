...
public:
	...
	static bool isMousePressed(int button) { return mouse_state & (1<<button); }
	static bool wasMousePressed(int button) { return (prev_mouse_state & (1 << button)) && !(mouse_state & (1 << button)); }
